import { Link, Navbar as NextUINavbar, NavbarContent, NavbarMenu, NavbarMenuToggle, NavbarBrand, NavbarItem, Button } from '@nextui-org/react';
        ...
        <div className="flex flex-col justify-between items-center w-full gap-2">
          {siteConfig.navItems.map((item) => (
            <NavbarItem className="w-full" key={item.href}>
              <NextLink className="flex items-center justify-center text-lg w-full border-gray-300 border-2 px-4 my-2" href={item.href}>
                {item.label}
              </NextLink>
            </NavbarItem>
          ))}
